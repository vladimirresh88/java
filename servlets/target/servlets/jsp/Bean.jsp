...
<body>
    <%! String name = "Krilov";%>
    <jsp:useBean id="person" class="jsphelpers.Person" scope="application"/> <!-- scope определяет то где виден данный бин -->
    ...
    <!--jsp:setProperty name="person1" property="strong" value="Very"/-->
    <jsp:getProperty name="person1" property="age"/>
    <jsp:getProperty name="person1" property="name"/>
    <!--jsp:getProperty name="person1" property="strong"/-->
</body>
</html>
